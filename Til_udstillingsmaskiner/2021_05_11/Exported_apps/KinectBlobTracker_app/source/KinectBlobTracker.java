...
public class KinectBlobTracker extends PApplet {
...
public void sendBlobsOsc(){
  ...
  for (Blob b : blobs){
    ...
    myMessage.add(PApplet.parseInt(b.getNrOfPixels())); // add blob nr of pixels
    blobsAdded = true;
  }  
...
public void loadSettings(String path) {
  ...
  disableSimulation = PApplet.parseBoolean(settings[12]);
  exit_on_kinect_error = PApplet.parseBoolean(settings[13]);
  logsEnabled = PApplet.parseBoolean(settings[14]);
...
class Tracker{
  ...
  */
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "KinectBlobTracker" };
    if (passedArgs != null) {
