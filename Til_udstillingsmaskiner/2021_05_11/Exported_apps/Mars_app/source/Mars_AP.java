...
public class Mars_AP extends PApplet {
...
public void setup() {
  ...
  spheresFX[0].rate.setMinMax(0.92f, 1.0f);
  ...
  spheresClean[0].rate.setMinMax(0.92f, 1.0f);
  ...
  spheresFX[2].enableDelay(this, 0.3f); // 0.3 is the delay tape // ###delay
  spheresFX[2].delayVal.setVal(0.5f, 1); // ### delay value must be between 0.3 and 0.8, or min max must be changed
  spheresFX[2].enableRate(); // ### rate
  spheresFX[2].rate.setMinMax(0.92f, 1.0f);
  ...
  spheresClean[2].enableDelay(this, 0.3f); // 0.3 is the delay tape // ###delay
  spheresClean[2].delayVal.setVal(0.5f, 1); // ### delay value must be between 0.3 and 0.8, or min max must be changed
  spheresClean[2].enableRate(); // ### rate
  spheresClean[2].rate.setMinMax(0.92f, 1.0f);
  ...
  spheresFX[3].rate.setMinMax(0.92f, 1.0f);
  ...
  spheresClean[3].rate.setMinMax(0.92f, 1.0f);
  ...
  spheresFX[4].enableDelay(this, 0.3f); // 0.3 is the delay tape // ###delay
  spheresFX[4].delayVal.setVal(0.5f, 1); // ### delay value must be between 0.3 and 0.8, or min max must be changed
  ...
  spheresClean[4].enableDelay(this, 0.3f); // 0.3 is the delay tape // ###delay
  spheresClean[4].delayVal.setVal(0.5f, 1); // ### delay value must be between 0.3 and 0.8, or min max must be changed
  ...
  spheresFX[5].rate.setMinMax(0.92f, 1.0f);
  ...
  spheresClean[5].rate.setMinMax(0.92f, 1.0f);
  ...
  spheresFX[6].rate.setMinMax(0.92f, 1.0f);
  ...
  spheresClean[6].rate.setMinMax(0.92f, 1.0f);
  ...
  spheresFX[7].rate.setMinMax(0.92f, 1.0f);
  ...
  spheresClean[7].rate.setMinMax(0.92f, 1.0f);
  ...
  spheresFX[8].rate.setMinMax(0.92f, 1.0f);
  ...
  spheresClean[8].rate.setMinMax(0.92f, 1.0f);
  
  // turn down the max vol of all the clean
  for (int i = 0; i < spheresClean.length; i++){
    spheresClean[i].vol.setMinMax(0.00001f, 0.6f); // ### 2-track : 
  }
...
class ValueFader{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Mars_AP" };
    if (passedArgs != null) {
